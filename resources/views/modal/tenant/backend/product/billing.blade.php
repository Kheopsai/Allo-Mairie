<x-card title="{{ __('Pricing Options') }}">
    ...
    <section
        ...
        <div class="box-border max-w-6xl px-4 pb-7 mx-auto border-solid sm:px-6 md:px-6 lg:px-4">
            ...
            @else
                <div x-data="{ activeIndex: 0 }" class="flex justify-between mx-auto mt-6 overflow-hidden ">
                    <button @click="activeIndex = (activeIndex === 0) ? {{ $products->count() - 1 }} : activeIndex - 1;"
                        class="absolute left-0 p-3  bg-primary text-white rounded-full ">
